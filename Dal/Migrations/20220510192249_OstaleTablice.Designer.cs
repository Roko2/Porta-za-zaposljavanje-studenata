...
namespace Dal.Migrations
{
    ...
    [Migration("20220510192249_OstaleTablice")]
    partial class OstaleTablice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dal.Classes.KategorijaRadnika", b =>
                {
                    b.Property<int>("KategorijaRadnikaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KategorijaRadnikaId"), 1L, 1);

                    b.Property<string>("Naziv")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("KategorijaRadnikaId");

                    b.ToTable("KategorijaRadnika");
                });
            ...
            modelBuilder.Entity("KategorijaRadnikaPosao", b =>
                {
                    b.Property<int>("KategorijeRadnikaKategorijaRadnikaId")
                        .HasColumnType("int");

                    b.Property<int>("PosloviPosaoId")
                        .HasColumnType("int");

                    b.HasKey("KategorijeRadnikaKategorijaRadnikaId", "PosloviPosaoId");

                    b.HasIndex("PosloviPosaoId");

                    b.ToTable("KategorijaRadnikaPosao");
                });
            ...
            modelBuilder.Entity("KategorijaRadnikaPosao", b =>
                {
                    b.HasOne("Dal.Classes.KategorijaRadnika", null)
                        .WithMany()
                        .HasForeignKey("KategorijeRadnikaKategorijaRadnikaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
